...
if uploaded_file:
    ...
    # define recipes
    meal_recipes = {
        "Spaghetti Bolognese": {"batch":90, "ingredients":{...}},  # full dict retained
        # ... other recipes ...
    }
    ...
    def draw_meal(idx, name, data):
        # existing draw_meal implementation
        ...
    # loop with pagination
    for name, data in meal_recipes.items():
        # calculate number of rows including sub_section
        main = len(data.get("ingredients", {}))
