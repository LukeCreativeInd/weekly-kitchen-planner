...
start_y = 20  # After title header, adjust as needed

# Draw all sections in order, chaining Y position
last_y = draw_bulk_section(pdf, meal_totals, xpos, col_w, ch, pad, bottom, start_y)
last_y = draw_recipes_section(pdf, meal_totals, xpos, col_w, ch, pad, bottom, last_y)
last_y = draw_sauces_section(pdf, meal_totals, xpos, col_w, ch, pad, bottom, last_y)
last_y = draw_fridge_section(pdf, meal_totals, xpos, col_w, ch, pad, bottom, last_y)
last_y = draw_chicken_mixing_section(pdf, meal_totals, xpos, col_w, ch, pad, bottom, last_y)
last_y = draw_meat_veg_section(pdf, xpos, col_w, ch, pad, bottom, last_y)
