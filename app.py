...
if uploaded_file:
    ...
    pdf.ln(5)
    meal_recipes = {
        "Spaghetti Bolognese":{"batch":90,"ingredients":{"Beef Mince":100,"Napoli Sauce":65,"Crushed Tomatoes":45,"Beef Stock":30,"Onion":15,"Zucchini":15,"Carrot":15,"Vegetable Oil":1,"Salt":2,\
       "Pepper":0.5,"Spaghetti":68}},
        "Beef Chow Mein":{"batch":80,"ingredients":{"Beef Mince":120,"Celery":42,"Carrot":42,\
       "Cabbage":42,"Onion":42,"Oil":2,"Pepper":0.8,"Soy Sauce":13,"Oyster Sauce":13,"Rice":130}},
        "Shepherd's Pie":{"batch":82,"ingredients":{"Beef Mince":100,"Oil":2,"Carrots":15,\
       "Capsicum":15,"Onion":15,"Mushroom":15,"Peas":15,"Tomato Paste":6,"Beef Stock":20,\
       "Salt":2,"Pepper":0.5,"Napoli Sauce":70}},
        "Beef Burrito Bowl":{"batch":130,"ingredients":{"Beef Mince":95,"Onion":12,"Capsicum":12,\
       "Vegetable Oil":2,"Taco Seasoning":7,"Salt":1.5,"Pepper":0.5,"Beef Stock":40}},
        "Beef Meatballs":{"batch":0,"ingredients":{"Mince":150,"Onion":10,"Parsley":3,\
       "Salt":1.5,"Pepper":0.2}},
        "Lebanese Beef Stew":{"batch":80,"ingredients":{"Chuck Diced":97,"Onion":30,"Carrot":30,\
       "Potato":30,"Peas":30,"Oil":2,"Salt":2.5,"Pepper":0.5,"Tomato Paste":20,"Water":30,\
       "Beef Stock":30,"Rice":130}},
        "Mongolian Beef":{"batch":0,"ingredients":{"Chuck":97,"Baking Soda":2.5,\
       "Water":10,"Soy Sauce":5,"Cornflour":2.5}},
        "Chicken With Vegetables":{"batch":0,"ingredients":{"Chicken":135,"Corn":52,\
       "Beans":60,"Broccoli":67}},
        ...
        "Chicken Pesto Pasta":{"batch":0,"ingredients":{"Chicken":130,"Penne":59,\
       "Sundried Tomatoes":24}},
        "Chicken and Broccoli Pasta":{"batch":0,"ingredients":{"Chicken":130,"Penne":59,\
       "Broccoli":40}},
       ...
       "sub_section":{"title":"Chickpea Recipe","ingredients":{"Onion":20,"Zucchini":30,\
       "Red Capsicum":30,"Garlic":2,"Oil":2,"Chickpeas":115,"Mix Spices":1.7,\
       "Chicken Stock":50}}}
    }
    heights = [pdf.get_y(), pdf.get_y()]
    col = 0
    ...
    # ------------------
    # Chicken Mixing & Remaining Mixes
    # ------------------
    mixes = [
        ("Chicken Mixing", "Pesto", [("Chicken",110),("Sauce",80)], "CHICKEN PESTO PASTA"),
        ("Butter Chicken Mixing", "Butter Chicken", [("Chicken",120),("Sauce",90)], "BUTTER CHICKEN"),
        ("Broccoli Pasta Mixing", "Broccoli Pasta", [("Chicken",100),("Sauce",100)], "CHICKEN AND BROCCOLI PASTA"),
        ("Thai Mixing", "Thai", [("Chicken",110),("Sauce",90)], "THAI GREEN CHICKEN CURRY")
    ]
    for title,mix_title,ingredients,meal_key in mixes:
        pdf.ln(5)
        pdf.set_font("Arial","B",14)
        pdf.cell(0,10,title,ln=1,align='C')
        pdf.ln(5)
        ...
        for h,w in zip(headers,widths): pdf.cell(col_w*w, ch, h, 1)
        pdf.ln(ch)
        amt = meal_totals.get(meal_key.upper(),0)
