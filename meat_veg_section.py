...
def draw_meat_veg_section(
    ...
    meat_order = [
        ...
        # Italian Chicken = 153g x meals from these 4 dishes
        ...
        # Normal Chicken = 130g x meals from these 5 dishes
    ...
    # Veg prep rows -- add or update logic as needed for your new calculations
    veg_prep = [
